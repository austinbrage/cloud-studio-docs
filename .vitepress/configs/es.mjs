...
export const es = defineConfig({
    ...
    lang: 'es-EN',
    title: "Cloud studio",
    description: "CloudStudio es una aplicación de escritorio que crea, edita y ejecuta proyectos de terraform / ansible",
    ...
    themeConfig: {
        ...
        socialLinks: [
            { icon: 'discord', link: 'https://discord.gg/ChgyCwTKKf' },
